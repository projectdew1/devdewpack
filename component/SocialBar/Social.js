    ...
    return (
        <Zoom in={true}>
            <div className={classes.root} onClick={() => setCheck(!check)}>
                ...
                <Tooltip title="ติดต่อ Facebook" placement="right" onClick={() => window.open("https://www.facebook.com/kmsmachinerythailand")}>
                    <div className={icon2}>
                        <i className="fab fa-facebook-square" />
                    </div>
                </Tooltip>
                <Tooltip title="ติดต่อ Line official" placement="bottom-end" onClick={() => window.open("https://page.line.me/?accountId=kmsmachinery")}>
                    <div className={icon3}>
